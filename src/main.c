...
int tamano_total_segmentos(short segmento_sizes[]);
...
*/
int verifico_tamano2(short segmento_sizes[]) {
    return tamano_total_segmentos(segmento_sizes) <= TAMANO_MEMORIA;
}

/*
    Calculo el tamaño total de los segmentos
    @param segmento_sizes: array con los tamaños de los segmentos
    @return: tamaño total de los segmentos
*/
int tamano_total_segmentos(short segmento_sizes[]) {
    int total_size = 0;
    for (int i = 0; i < 6; i++) {
